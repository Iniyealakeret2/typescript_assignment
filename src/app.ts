...
let option: number = value("Enter your option: ");
...
if (option == 1) {
  ...
  console.log();
  let _firstname: string = value("Enter your first name: ");
  let _lastname: string = value("Enter your last name: ");
  let _occupation: string = value("Enter your occuation: ");
  let _id: string | number = value("Enter your Id: ");
  ...
  console.log();
  let fname: string = value("Enter your first name: ");
  let lname: string = value("Enter your last name: ");
  let sOccupation: string = value("Enter your occuation: ");
  let sId: string | number = value("Enter your Id: ");
